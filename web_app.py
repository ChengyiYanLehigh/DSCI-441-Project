...
def update_recommendations(recommend_clicks, dislike_clicks, liked_data, disliked_data):
    ...
    if 'recommend-button' in triggered_id:
        ...
        recommendations = recommender.recommend_movies(liked_data, disliked_movies=disliked_data)
        ...
        new_recommendations = recommender.recommend_movies(new_liked_data, disliked_movies=disliked_data)
