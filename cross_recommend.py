...
class CrossRecommender:
    def __init__(self, data_path, sim_matrix_path='all_cosine_sim.joblib'):
    ...
    def recommend_movies(self, liked_movie, disliked_movies=[], n=5):
        recommendations = []
...
if __name__ == "__main__":
    ...
    print(recommender.recommend_movies(['Blood & Water', 'Sin Senos sí Hay Paraíso']))
